...
def main(config):
    ...
    if config.dataset in ['CelebA', 'Both']:
        ...
        service_loader, full_label=service_get_loader(config.celeba_image_dir, config.attr_path, config.selected_attrs,config.all_attrs, config.celeba_crop_size, config.image_size, 1, 'CelebA', config.mode, config.num_workers)
...
<<<<<<< HEAD
    if config.mode=='service':
        solver = Solver(celeba_loader, rafd_loader, service_loader,  config, wandb)
...
parser.add_argument("--selected", type=list, default=["Narrow_Eyes", "Straight_Hair", "Pale_Skin",  "hair_color", "Receding_Hairline", "Bald", "Oval_Face", 
            ...
            "Heavy_Makeup"], [ "Mouth_Slightly_Open", "Straight_Hair", "Bushy_Eyebrows", "Bangs", "5_o_Clock_Shadow", "Big_Lips", "Narrow_Eyes", 
             "Double_Chin", "Wavy_Hair", "Pointy_Nose", "Chubby", "Arched_Eyebrows", "Big_Nose", "Young", "Male", "Heavy_Makeup", "Wearing_Lipstick"], ["hair_color", "Young", "Straight_Hair", "Receding_Hairline", "Chubby", "Big_Lips", "5_o_Clock_Shadow", "No_Beard", "Oval_Face", "Rosy_Cheeks", "Male",
            "Heavy_Makeup", "Wearing_Lipstick", "Mouth_Slightly_Open"], ["Narrow_Eyes", "Straight_Hair", "Pale_Skin", "Mouth_Slightly_Open", "hair_color", "Receding_Hairline", "Oval_Face", "Goatee", "Big_Nose",
            "Attractive", "Arched_Eyebrows", "5_o_Clock_Shadow", "No_Beard", "Heavy_Makeup", "Wearing_Lipstick"],
            ["Bald", "Pointy_Nose", "hair_color", "Young", "Straight_Hair", "Attractive", "Chubby", "Oval_Face", "Male", "Narrow_Eyes", "Rosy_Cheeks",
            "High_Cheekbones"],["hair_color", "Straight_Hair", "Big_Lips","Young",
...
parser.add_argument('--reversed_attrs', type=list, nargs='+', help='selected attributes for the CelebA dataset',
                    default=[
                        #1
                       ["Narrow_Eyes", "Straight_Hair", "Pale_Skin",  "hair_color", "Receding_Hairline", "Bald", "Oval_Face",
            "Double_Chin", "Bushy_Eyebrows"],
                       #2
            [ "Mouth_Slightly_Open", "Straight_Hair", "Bushy_Eyebrows", "Bangs", "5_o_Clock_Shadow", "Big_Lips", "Narrow_Eyes"],
            #3
            ["hair_color", "Young", "Straight_Hair", "Receding_Hairline", "Chubby", "Big_Lips"  ],
            #4
            ["Narrow_Eyes", "Straight_Hair", "Pale_Skin", "Mouth_Slightly_Open", "hair_color", "Receding_Hairline", "Oval_Face"],
            #5
            ["Bald", "Pointy_Nose", "hair_color", "Young", "Straight_Hair", "Attractive", "Chubby"],
            #6
            ["hair_color", "Straight_Hair", "Big_Lips","Young"])
...
<<<<<<< HEAD
parser.add_argument('--mode', type=str, default='service', choices=['train', 'test', 'service'])
...
<<<<<<< HEAD
parser.add_argument('--resume-from', default="/data/checkpoints/yerin/starGAN/1/celeba128/experiment/onlyReversed6_stargan_lr0.0001_bs16_recon10_lambda1.0/iter230000")
=======
